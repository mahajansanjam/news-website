...
<div class="section-two">
    <div class="container-food">
        ...
        $sql = "SELECT id, title, thumbImage, descrption, videolink,created_at FROM add_news_users WHERE id='" . $id . "' ";
                            ...
                            <?php if (!empty($newsData)): ?>
                                <?php foreach ($newsData as $article): ?>
                                    <div class="article-item">
                                        <?php
                                        $article = $newsData; // just rename it for consistency
                                        $backgroundImage = "uploads/" . htmlspecialchars($article['thumbImage']);
                                        ?>
                                        <div style="background-image: url('<?= $backgroundImage ?>'); height: 300px; background-size: cover;"></div>
