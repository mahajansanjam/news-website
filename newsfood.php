...
<div class="section-two">
    <div class="container-food">
        ...
        $sql = "SELECT id, tittle, thumbimage, descrption, created_at, videolink FROM topbar_news WHERE id='" . $id . "' ";
                ...
                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-2">
                                            <div class="profile-pic">
                                                <?php
                                                $sql = "SELECT thumbimage FROM topbar_news ORDER BY id DESC LIMIT 1";
                                                $result = $conn->query($sql);
                    ...
                    <div class="col-lg-3">
                        <div class="share-post-data">
                            ...
                            $sql = "SELECT id, tittle, thumbimage, descrption, created_at FROM topbar_news ORDER BY created_at DESC LIMIT 5";
                            $result = $conn->query($sql);
                ...
                <div class="container-food">
                    <div class="perspective-pics">
                        <div class="row">
                            ...
                            $sql = "SELECT id, tittle, thumbimage,created_at FROM topbar_news ORDER BY created_at DESC LIMIT 4";
                            $result = $conn->query($sql);
